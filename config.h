...
static const char colors[NUMCOLORS][ColLast][9] = {
  ...
  {		S_base02  , S_base01  , S_base03	 }, // 1 = normal
  {		S_blue    , S_base03  , S_base01	 }, // 2 = selected
  {		S_magenta , S_orange  , S_base03	 }, // 3 = urgent
...
static const Rule rules[] = {
	...
	{ "Gtkevemon"      , NULL         , NULL                  , 1 << 5    , True       , True      , -1 }    ,
	{ NULL             , "weechat"    , NULL                  , 1 << 3    , False      , False     , -1 }    ,
	{ NULL             , "mail"       , NULL                  , 1 << 3    , False      , False     , -1 }    ,
	{ NULL             , "mixer"      , NULL                  , 0         , True       , True      , -1 }    ,
	{ "Ossxmix"         , NULL         , NULL                  , 0         , True       , True      , -1 }    ,
	{ NULL             , "music"      , NULL                  , 0         , True       , True      , -1 }    ,
	{ "Galculator"     , NULL         , NULL                  , 0         , True       , True      , -1 }    ,
	{ "Xmessage"       , "xmessage"   , NULL                  , 0         , True       , True      , -1 }    ,
	{ NULL             , NULL         , "sc2 - Wine desktop"  , 1 << 8    , False      , False     , -1 }    ,
	{ NULL             , NULL         , "eveA - Wine desktop" , 1 << 9    , False      , False     , -1 }    ,
	{ NULL             , NULL         , "eveB - Wine desktop" , 1 << 10   , False      , False     , -1 }    ,
	{ NULL             , NULL         , "eveC - Wine desktop" , 1 << 11   , False      , False     , -1 }    ,
};
...
static const char *mixercmd[]      = { "ossxmix", NULL };
static const char *volmcmd[]       = { "/home/chris/dev/bin/ossvol", "-t", NULL };
static const char *voldcmd[]       = { "/home/chris/dev/bin/ossvol", "-d", "2", NULL };
static const char *volucmd[]       = { "/home/chris/dev/bin/ossvol", "-i", "2", NULL };
...
static Key keys[] = {
	...
	// Patch: cycle
	{ MODKEY,												XK_slash,			cycle,					{.i = -1 } },
	{ MODKEY,												XK_backslash,	cycle,					{.i = +1 } },
	{ MODKEY|ShiftMask,							XK_slash,			tagcycle,				{.i = -1 } },
	{ MODKEY|ShiftMask,							XK_backslash,	tagcycle,				{.i = +1 } },
...
static Button buttons[] = {
	...
	{ ClkClientWin,         Mod1Mask,       Button4,        cycle,			    {.i = -1} },
	{ ClkClientWin,         Mod1Mask,       Button5,        cycle,					{.i = +1} },
	{ ClkRootWin,		        Mod1Mask,       Button4,        cycle,			    {.i = -1} },
	{ ClkRootWin,	          Mod1Mask,       Button5,        cycle,					{.i = +1} },
